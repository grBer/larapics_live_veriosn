                ...
                <div class="col-md-6">
                    <fieldset>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="user[username]" id="username" class="form-control @error('user.username') is-invalid @enderror" value="{{old('user.username', $user->username)}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="user[name]" id="name" class="form-control @error('user.name') is-invalid @enderror" value="{{old('user.name',$user->name)}}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="profile_image">Profile Image</label>
                            <input type="file" name="user[profile_image]" id="profile_image" class="form-control @error('user.profile_image') is-invalid @enderror" value="{{old('user.profile_image', $user->profile_image)}}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="user[city]" id="city" class="form-control @error('user.city') is-invalid @enderror" value="{{old('user.city', $user->city)}}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="country">Country</label>
                            <input type="text" name="user[country]" id="country" class="form-control @error('user.country') is-invalid @enderror" value="{{old('user.country', $user->country)}}">
                        </div>
                        <div class="mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <fieldset class="mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="social[facebook]" id="facebook" class="form-control @error('social.facebook') is-invalid @enderror"
                                placeholder="https://www.facebook.com/..." value="{{old('social.facebook', $user->social->facebook)}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="social[twitter]" id="twitter" class="form-control @error('social.twitter') is-invalid @enderror"
                                placeholder="https://twitter.com/..." value="{{old('social.twitter', $user->social->twitter)}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="social[instagram]" id="instagram" class="form-control @error('social.instagram') is-invalid @enderror"
                                placeholder="https://www.instagram.com/..." value="{{old('social.instagram', $user->social->instagram)}}">
                    ...
                    <fieldset class="mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            {{-- ΕΔω ήταν το name  στο ακριβώς απο πάνω και στο ακριβώς απο κάτω input settings αντί για options
                            και έσπαγε ο κώδικας διεγραφες και ότι υπήρχε στην βάση --}}
                            <div class="form-check">
